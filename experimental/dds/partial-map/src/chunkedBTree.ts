 ...
 */
 export interface Handler<T, TNodeHandle, TValueHandle> {
    ...
    compareHandles: (a: TNodeHandle, b: TNodeHandle) => number;
 ...
 * TODO: docs
 */
export class ChunkedBtree<T, THandle, TValueHandle> implements IChunkedBtree<T, THandle> {
    ...
    private cloneWithNewRoot(newRoot: IBTreeNode<T, THandle>): ChunkedBtree<T, THandle, TValueHandle> {
    ...
    public async delete(key: string, deletedHandles: THandle[]): Promise<ChunkedBtree<T, THandle, TValueHandle>> {
...
class BTreeNode<T, THandle> {
    ...
    public async set(
        key: string, value: T, addedHandles: THandle[], deletedHandles: THandle[],
...
class LeafyBTreeNode<T, THandle> implements IBTreeNode<T, THandle> {
    public constructor(
        ...
        public readonly discoverHandles: (value: T) => Iterable<THandle>,
    ) {
...
class LazyBTreeNode<T, THandle> implements IBTreeNode<T, THandle> {
    ...
    public constructor(
        ...
        private readonly discoverHandles: (value: T) => Iterable<THandle>,
    ) {}
